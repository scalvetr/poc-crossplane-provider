# poc-crossplane-provider

`poc-crossplane-provider` is a minimal [Crossplane](https://crossplane.io/) Provider
...
1. Find-and-replace `poc-crossplane-provider` with your provider's name.
