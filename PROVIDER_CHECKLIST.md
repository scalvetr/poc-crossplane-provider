...
The [poc-crossplane-provider](https://github.com/scalvetr/poc-crossplane-provider-provider) repository can be
...
The [poc-crossplane-provider](https://github.com/scalvetr/poc-crossplane-provider-provider)
