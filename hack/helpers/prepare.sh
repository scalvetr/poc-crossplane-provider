...
sed -i.bak "s/poc-crossplane-provider/provider-${ProviderNameLower}/g" go.mod
...
git mv "cluster/images/poc-crossplane-provider" "cluster/images/provider-${ProviderNameLower}"
git mv "cluster/images/poc-crossplane-provider-controller" "cluster/images/provider-${ProviderNameLower}-controller"
